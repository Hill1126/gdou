    ...
    <body id="bg">
        ...
        <div class="container">
            <div class="menus_area" id="menus_area">
                <div class="line"></div>
                <dl class="system_log">
                    <dt>学生信息<img src="images/left/select_xl01.png"></dt>
                    <dd class="first_dd"><a href="${pageContext.request.contextPath }/showAllStudent" target="mainFrame">查看全部信息</a></dd>
                    <dd><a href="${pageContext.request.contextPath }/manage_add.jsp" target="mainFrame">添加学生信息</a></dd>
                </dl>
