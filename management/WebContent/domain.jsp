		...
		<div class="main w3l">
			...
			method="post" accept-charset="UTF-8">
					...
					<div class="first-line agileits">
						...
						<div class="span6 main-row">
							<div class="input">
								...
								<input type="text" id="Ssno" name="Ssno" value="${student.ssno }" required disabled>
				...
				<div class="main-row">
					...
					<div class="main-row">
						<div class="input">
							<textarea value="${student.sdescribe }" spellcheck="false" name="Sdescribe"></textarea>
				...
				<div class="footer">
					<button type="submit" class="primary-btn" value="修改">修改</button>
